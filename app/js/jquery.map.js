...
Location = function (obj) {
    ...
    var _self = this,
        ...
        _wherePopup = $('.place__popup'),
        _where__labels = $('.place__labels'),
        _where__layout = $('.place__layout'),
        _map = null,
        _scroll = null,
    ...
    var _onEvents = function () {
        ...
        _showAllLocations = function (data) {
            var listLocations = '';
            listLocations += '<span class="label" v-bind:style="styles.label" @click="doEdit(\'label\', $event, true)" style="color: ' + data.color + '" data-id="' + data.id + '">' + data.title + '</span>';
